/* ==========================================================
 * Carousel_ege.js v2.0.1
 * ==========================================================
 * Copyright 2012 xsokev - egiron
 *
...
define([
...
], function (CarouselItem_ege, support, _BootstrapWidget, declare, lang, array, _TemplatedMixin, _Container, query, on, mouse, domConstruct, domClass, domAttr) {
    ...
    var _active = function () {
        ...
        _slide = function (type, next, mute) {
            ...
            if (!(next instanceof CarouselItem_ege)) {
    ...
    return declare("Carousel_ege", [_BootstrapWidget, _TemplatedMixin, _Container], {
        // summary:
        ...
        //
        //      ## Events ##
        //		Call `widget.on("slide", func)` to monitor when a CarouselItem_ege starts transitioning.
        //
        //		Call `widget.on("slid", func)` to monitor when a CarouselItem_ege has finished transitioning.
        //
        // example:
        // |  <div id="my-carousel" class="slide" data-dojo-type="Carousel" data-dojo-props="...">
        // |      <div data-dojo-type="CarouselItem_ege" data-dojo-props="img:'img1.jpg', title:'One', content:'Uno'"></div>
        // |      <div data-dojo-type="CarouselItem_ege" data-dojo-props="img:'img2.jpg', title:'Two', content:'Dos'"></div>
        // |      <div data-dojo-type="CarouselItem_ege" data-dojo-props="img:'img3.jpg', title:'Three', content:'Tres'"></div>
        // |  </div>
        //
        // example:
        // |	new Carousel({interval: 5000, pauseOnHover: false}, dojo.create('div'));
        //
        ...
        postCreate: function () {
            ...
            if (this.indicators) {
                query("[data-dojo-type*='CarouselItem_ege']", this.domNode).forEach(function (item, index) {
                    var indicator = domConstruct.toDom("<li>"+(index+1)+"</li>");
        ...
        to: function (/*Number*/ position, /*Boolean?*/ mute) {
            ...
            // position:
            //      zero based index of CarouselItem_ege
            // mute:
