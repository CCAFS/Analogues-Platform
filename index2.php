<?php 
 ...
 ?>
    ...
    <link rel="stylesheet" href="css/analoguesdtb.css">
    ...
    <![endif]-->
			...
			<!-- <header>
				...
				<div class="LogoCCAFS unselectable"></div>
				<div class="appName unselectable">Climate Analogues</div>
				<div style="float: right"><a href="http://www.ccafs-analogues.org" target="_blank" rel="external" class="btn"><i class="icon-info-sign"></i> About</a></div>
				<span class="subtitle">A glimpse of tomorrow's climates, today</span>
				<hr/>
			</header>-->
			<div id="alertMsg" class="alertaError alert alert-error fade in"><div id="errMsg"></div></div>
			<div id="analoguesSteps"></div>
			<div id="mapgallery">
				<hr/>
...
?>
    ...
    <script type="text/javascript" src="js/climateAnalogues_v1.js"></script>
    <script></script>
